...
export const Data: DataType[] = [
  {
   image: `${firstImage}`,
   title: 'Monitor Gamer SuperFrame Precision, 27 Pol, Curvo, Full HD, 1ms, 240Hz, FreeSync, HDMI/DP, SFP2702G',
   value: 'R$ 999,90',
   key: 0,
  },
  {
  ...
  {
   image: `${thirdImage}`,
   title: 'Monitor Gamer SuperFrame Precision, 23.6 Pol, Curvo, Full HD, 1ms, 180Hz, 99% sRGB, FreeSync, HDMI/DP, SF',
   value: 'R$ 699,90',
   key: 2,
  },
  {
